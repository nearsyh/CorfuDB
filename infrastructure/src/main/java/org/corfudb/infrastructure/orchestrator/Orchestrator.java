...
public class Orchestrator {
    ...
    public static class WorkflowFactory {
        AddNodeWorkflow getAddNode(AddNodeRequest req) {
            return new AddNodeWorkflow(req);
        }

        RemoveNodeWorkflow getRemoveNode(RemoveNodeRequest req) {
            return new RemoveNodeWorkflow(req);
        }

        ForceRemoveWorkflow getForceRemove(ForceRemoveNodeRequest req) {
            return new ForceRemoveWorkflow(req);
        }

        HealNodeWorkflow getHealNode(HealNodeRequest req) {
            return new HealNodeWorkflow(req);
        }

        RestoreRedundancyMergeSegmentsWorkflow getRestoreRedundancy(RestoreRedundancyMergeSegmentsRequest req) {
